...
const SidebarLink = ({ icon, label, to, onClick }) => (
    <Nav.Link
        ...
        to={to || "#"}
        className={({ isActive }) =>
            `d-flex align-items-center px-3 py-2 mb-1 rounded ${isActive
...
const StaticSidebarContent = ({ toggleSidebar }) => {
    const links = [
        ...
        { icon: novelsIcon, label: "Current Novels", to: "/novels" },
    ...
    const footerLinks = [
        { icon: "bi bi-question-circle", label: "Support", to: "/support" },
